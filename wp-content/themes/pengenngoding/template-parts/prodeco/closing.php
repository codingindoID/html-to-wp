<section id="penutup" class="mt-5">
    <div class="container py-5">
        <div data-aos="flip-left">
            <h3 class="text-tema-dark font-weight-bold img-product">EVERY COLOUR FOR EVERY BOARD TYPE</h3>
            <p class="fw-100 img-product">All colours in this web page are available in <b>Melamine Faced Blockboard, Melamine Faced Plywood, Melamine Faces MDF, Melanine Faced Chipboard</b> </p>
        </div>
        <div class="row" data-aos="fade-right">
            <div class="col-md-8">
                <h1 class="f-200 m-0 img-product">01 <small class="font-weight-bold">MFB</small> </h1>
                <h4 class="m-0 img-product"><small>Melamine Faced Bloackboard</small></h4>
                <hr>
        ...
        <div class="row d-flex justify-content-end" data-aos="fade-left">
            <div class="col-md-12 text-right">
                ...
                <hr>
                <p class="text-right img-product">Covered in Hard-wearing UV-resistant melamine impregnated paper film that is chemically bonded under heat & preasure to a dimensionally-stable plywood core,melamine faced plywoods are tough, waterproof and scratch resistant. They are uses extensively in the manufacture of furniture, kitchen & toys and instalations such as shopfitting, exhibitions & displays , workshops & vehicle conversions.</p>
                <p class="img-product">The coating has good colour stability and chemical resistance. Many household detergents can therefore be used safety on the surface, thus making it very easy to keep clean.</p>
                <p class="img-product">These panels are supplied from stock in the form of white melamine faced birch plywood - a smooth white film banded onto an exterior banded birch plywood core. Other colours, woodgrains & different core plywoods such as lightweight okoume plywood are available to special order in pallet/multi-pallet quantities.</p>
            </div>
        </div>
